...
function Footer() {
  ...
  return (
    <div>
      <div className=" flex  border-t-2  px-24 mt-16">
        ...
        <div className="ml-12 ">
          ...
          <div className="pt-6 text-left ml-3">
            <span className="text-d14 font-normal	">Download the Mobile App Don't Miss The Opportunities!</span>
            ...
            <div className="w-full grid-flow-row  pt-3">
              <span className="w-full flex place-content-center leading-snug" ><img src={supportImage} alt="22" className="w-16 " /></span> 
              <span className="w-full flex place-content-center text-d22 font-bold pt-3">961 03 555 665</span>{" "}
            </div>
          </div>
        </div>
      </div>
      <div className="bg-dbasenavy h-12  text-white text-d22 text-left px-24 p-1">
        ENGLISH HOME
      </div>
