...
function CategoryPlaceholder({style}) {
  return (
    <div
      className={`${style} container pt-2 mb-12`}
      ...
      <div className="flex">
        ...
        <div className="w-10/12 flex flex-col gap-6">
          ...
          <div className=" h-12 flex justify-between">
            <div className="placeholder_animation ml-2 bg-white h-10  w-full"></div>
            {/* <div className="placeholder_animation ml-2 bg-white h-10 my-4 w-full"></div> */}
