    ...
    return (
      <div className="bg-dgrey10">
        ...
        <div className="relative">
          <div className="fixed z-20 top-0 left-0 bg-dblackOverlay2 w-full h-full"></div>
          <div className="popup fixed  bg-dwhite1 top-1/2 h-3/5 w-4/5 z-30 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <div className="list">
          <div className="md:container">
            <div className="flex flex-col">
              <div
                className="border-b border-dgrey3 py-2.5 mt-1 bg-dwhite1 md:bg-transparent"
              ...
              >
                ...
                <div className="wrapper align-middle flex  items-center justify-center font-mono">
                  <div className="list-info-text text-dblack2 text-d15 flex flex-col md:flex-row w-full md:w-unset ">
                    ...
                    <div className="list-info-mobile-filters block md:hidden">
                      <div className="list__info__mobile-filters__line relative mb-1">
                        <div
                          className="filter-btn w-full h-9 py-4 rounded-md font-mono text-d14 text-dblack2 px-2.5 text-center align-middle"
