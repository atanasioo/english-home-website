...
function Login() {
  ...
  return (
    <div className="checkout-viewport bg-dgrey10">
      <div className="auth-register-mobile md:hidden"></div>
      <div className="container">
        <div className="auth-register flex justify-center mb-5 pt-5">
          <div className="w-1/2 relative px-5" data-id="login">
            <div className="auth-register__wrapper py-7 px-12 bg-dwhite1 min-h-full mb-12">
              <div className="authentication-login">
                <div className="auth_title text-d27 text-center text-dborderblack2 m-2.5 font-mono">
                  Login
                </div>
                <div>
                  <form method="post">
                    ...
                    <div className={`error-field text-dred4 hidden`}></div>
                    <input type="hidden" name="" />
                    ...
                    <div className="flex justify-between items-baseline -mt-2 -mb-3 relative ">
                      ...
                      <Link className="block mt-2 mb-4 text-d12 text-right">
          ...
          <div className="w-1/2 relative px-5" data-id="register">
            <div className="auth-register__wrapper py-7 px-12 bg-dwhite1 min-h-full mb-12">
              <div className="authentication-register">
                <div className="auth-box ">
                  <div className="auth__form--title text-d27 text-center text-dborderblack2 m-2.5">
                    Sign up
                  </div>
                  <div>
                    <form method="post">
                      ...
                      <div className="mt-3.5 relative flex items-center justify-between">
                        <div className="">
                          <input
                            ...
                            id=""
                            ref={signupFirst}
                            className="border border-dgrey3 text-d16 text-dborderblack2 h-14 mb-2.5 px-5 outline-none focus:border focus:border-dblack2"
                      ...
                      <div className="mt-3.5 relative">
                        ...
                        />
                        <div
                          className={`error-password text-dred4 hidden`}
                        ></div>
                      </div>
                      ...
                      <div className="sign-up flex mt-3.5 relative">
                        <button
                          type="submit"
                          className="text-d16 font-mono bg-dblue3 h-14 block text-center 
        ...
        <div className="login-register-secure-shopping flex justify-center items-center mt-12  bg-dgrey10">
            <img src="https://akn-eh.b-cdn.net/static_omnishop/eh590/assets/img/insurance.png" alt="" className="mb-8"/>
            <div className="text-d18 text-dborderblack2 ml-2.5 font-semibold mb-8">Secure shopping</div>
        </div>
      </div>
    </div>
  );
