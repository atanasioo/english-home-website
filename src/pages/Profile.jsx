      ...
      <div className="flex">
        ...
        <div className="w-8/12 p-10 border">
          <div classname="flex text-left	text-d12 border border-1 ">
            ...
            <div className="text-d12 w-full text-left" ><input className="bg-white text-left w-5/12 p-2  border" Ref={fnameRef.current.value}/> </div>
            <div className="text-d12 text-left py-2" >Surname </div>
            <div className="text-d12 w-full text-left" ><input className="bg-white text-left w-5/12 p-2  border" Ref={lnameRef.current.value} /> </div>
