                        ...
                        <div className="account-container-box mb-8 h-72 border border-dgrey5  px-6">
                          ...
                          <div className="account-desc text-left h-32 text-sm mb-7">
                            ...
                            <div className="  flex justify-between  w-full flex-row  ">
                              ...
                              {!address.verified && (
                                <button
                                  ...
                                  className=" border rounded-md border-dblue text-dblue  hover:bg-dblue bg-white hover:text-white transition-all px-3"
                                >
                                  Verify
                                </button>
                              )}
                            ...
                            <div
                              ...
                              } z-50 fixed px-5   rounded-md max-md:w-[350px] max-md:h-[350px] left-0 top-0 bottom-0 py-5 right-0  transition-opacity duration-300 bg-white my-auto mx-auto w-[450px] h-[350px]`}
                            >
                              <div className=" w-full relative">
                                ...
                                <div
                                  className={` ${
                                    codeSection ? "right-[500px]" : "right-0"
                                  ...
                                  <div className="  w-full h-full relative justify-center text-center flex flex-col gap-4">
                                    <div className=" mx-auto">
                                      ...
                                      <button
                                        ...
                                        className=" mt-8 w-full border border-dblue rounded-md text-dblue py-3 bg-white hover:bg-dblue flex flex-row justify-center gap-5 hover:text-white transition-all "
                                      >
                                        {" "}
                                        <span>Send </span>{" "}
                                        {loadingVerify && (
                                    ...
                                    <div className=" my-auto w-full  mx-auto">
                                      ...
                                      <div className=" w-full flex flex-row gap-2 ">
                                        ...
                                        <button
                                          ...
                                          className=" mt-8 w-full border border-dblue rounded-md text-white py-3 bg-dblue hover:bg-dblue2  transition-all "
                                        >
                                          {" "}
                                          <span>Cancel </span>{" "}
                                        </button>
